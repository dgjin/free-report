...
export const GlobalReadOnlyView: React.FC = () => (
  <div className="max-w-[1080px] mx-auto px-[22px] py-[clamp(20px,4vw,32px)] space-y-5">
    <div className="bg-[rgba(0,113,227,0.06)] border border-[rgba(0,113,227,0.12)] rounded-[18px] px-5 py-4">
      <p className="text-[13px] text-[#424245] leading-relaxed">
        <span className="font-semibold text-[#0071e3]">超级管理员全局只读视图：</span>
