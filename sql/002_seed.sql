...
(2,'hq_admin','$2b$10$GAr.BW5jLQH7lJZfS5sLW.C.Fl3mhWWAMJyfoDk0Uj2p02HJpyOlu','总部管理员',1,'headquarter_admin','active'),
...
INSERT IGNORE INTO report_templates (id,name,description,period_type,status,created_by) VALUES
(1,'月度销售与经营报表','汇总各分公司月度销售收入、利润及核心产品销售明细','monthly','published',1),
(2,'季度资产与设备清查表','清查各分公司季度固定资产、设备状况及盘点明细','quarterly','published',2);
...
INSERT IGNORE INTO report_assignments (id,template_id,assigned_to_company_id,title,period_label,deadline,status,assigned_by) VALUES
(1,1,2,'2026年7月月度销售与经营报表（北京）','2026年07月','2026-07-29','approved',1),
(2,1,3,'2026年7月月度销售与经营报表（上海）','2026年07月','2026-07-29','submitted',1),
(3,1,4,'2026年7月月度销售与经营报表（广州）','2026年07月','2026-07-29','filling',1),
(4,2,2,'2026年Q3资产与设备清查（北京）','2026年Q3','2026-07-29','pending',2),
(5,2,3,'2026年Q3资产与设备清查（上海）','2026年Q3','2026-07-29','pending',2);
