...
public class TemplateController {
    ...
    public void disableTemplateField(@PathVariable Long id, @PathVariable Long fieldId) {
        securityUtils.requireDepartmentReportAdmin();
        AuthUser user = securityUtils.getCurrentUser();
        templateService.disableTemplateField(user, id, fieldId);
    }

    @PostMapping("/{id}/matrix-fields")
    public List<Map<String, Object>> addMatrixFields(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        securityUtils.requireDepartmentReportAdmin();
        AuthUser user = securityUtils.getCurrentUser();
    ...
    public List<Map<String, Object>> assignTemplate(@PathVariable Long id,
